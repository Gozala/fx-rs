...
///
/// These provider traits are generated by ability! and provide all the necessary
/// Provider<Capability> impls via blanket implementations. The user only needs to
/// specify ability names like Counter or State<T> - the macro derives the provider
/// trait names automatically.
